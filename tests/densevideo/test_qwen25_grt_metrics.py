...
from lmms_eval.models import qwen2_5_vl as qwen25_module
...
class Qwen25GRTMetricsTest(unittest.TestCase):
    ...
    def _assert_custom_loader(self, decord_module):
        ...
        self.assertIn(
            "orig_fps=30.000000 duration_s=8.000000 total_frames=240 capped_frames=240 "
            "sampled_frames=8 effective_fps=1.000000",
